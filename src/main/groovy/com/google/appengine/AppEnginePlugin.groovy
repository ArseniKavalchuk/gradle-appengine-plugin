...
class AppEnginePlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        configureSetDefaultVersionTask(project)
    ...
    private void configureSetDefaultVersionTask(Project project) {
        project.tasks.withType(SetDefaultVersionTask).whenTaskAdded { SetDefaultVersionTask appengineSetDefaultVersionTask ->
            appengineSetDefaultVersionTask.conventionMapping.map(EXPLODED_WAR_DIR_CONVENTION_PARAM) { getExplodedAppDirectory(project) }
        }
